...
import dev.wsgroup.main.views.boxes.DialogBoxAddress;
...
public class RecViewAddressListAdapter extends RecyclerView.Adapter<RecViewAddressListAdapter.ViewHolder> {
    ...
    public RecViewAddressListAdapter(Context context, Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_view_address_list, parent, false);
